...
public class Server implements Parcelable{
    ...
    public Server(String hostName, String ipAddress, int ping, long speed, String countryLong, String countryShort, String ovpnConfigData, int port, String protocol) {
